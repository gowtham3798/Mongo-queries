...
db.company_drives.find({     
  ...
  db.product.find({     
      product_price:{$gt : 400,$lt : 800} }).pretty() 
  ...
  db.product.find({ id : "10" },{product_name : 1,product_material : 1} ).pretty()
  ...
  db.product.aggregate([
      {$match :{product_price:492.00},$match:{product_color:'indigo'}},
      {$group:{_id:'$product_name'}}
  ])
  
  // Delete the products which product price value are same
  db.product.deleteMany({product_price:47.00,product_price:36.00})
